...
def get_args():
    ...
    parser.add_argument('--nb_classes', default=51, type=int,
                        help='number of the classification types')
    parser.add_argument('--imagenet_default_mean_and_std', default=True, action='store_true')
    parser.add_argument('--num_segments', type=int, default= 1)
    parser.add_argument('--num_frames', type=int, default= 16)
    parser.add_argument('--sampling_rate', type=int, default= 4)
    parser.add_argument('--data_set', default='Kinetics-400', choices=['Kinetics-400', 'SSV2', 'UCF10', 'HMDB51', 'HMDB10', 'image_folder'],
...
def main(args, ds_init):
    ...
    if args.eval:
        preds_file = os.path.join(args.output_dir, '.txt')
        print('predict file for evaluation: ', preds_file)
    ...
    preds_file = os.path.join(args.output_dir, 'test.txt')
    print('test stats prediction: ', preds_file)
    test_stats = final_test(data_loader_test, model, device, preds_file)
    # torch.distributed.barrier()
    # if global_rank == 0:
    #     print("Start merging results...")
