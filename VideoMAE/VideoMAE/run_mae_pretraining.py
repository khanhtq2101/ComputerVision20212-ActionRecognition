...
def main(args):
    ...
    # print("Dataset size: {}, batch size {}, number of epoch {}".format(str(len(dataset_train)), str(args.batch_size), str( num_training_steps_per_epoch)))
    ...
    model.to(device)
    model_without_ddp = model # model without distributed data parallel
